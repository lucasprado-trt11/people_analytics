...
// Especificações Psicométricas (Baseado em Goldberg, 1992 e IPIP)
// Alpha: Confiabilidade teórica da escala (Referência Bibliográfica)
// SEM: Standard Error of Measurement (Erro Padrão de Medida estimado para a escala)
...
// AUDITORIA DE ITENS:
// Itens com key: -1 são "Reversos".
// Ex: "Tímido" é o oposto de Extroversão. Se o usuário marca "Sou Tímido" (5), o score de Extroversão cai.
// Se marca "NÃO sou Tímido" (1), o score de Extroversão sobe.
// A lista abaixo segue estritamente os marcadores de Goldberg.
const BIG_FIVE_ADJECTIVES = [
  ...
  { id: 8, text: "Convencional", trait: 'abertura', key: -1 }, // Reverso validado
  { id: 9, text: "Rotineiro(a)", trait: 'abertura', key: -1 }, // Reverso validado
  { id: 10, text: "Conservador(a)", trait: 'abertura', key: -1 }, // Reverso validado
  ...
  { id: 18, text: "Desorganizado(a)", trait: 'conscienciosidade', key: -1 }, // Reverso validado
  { id: 19, text: "Negligente", trait: 'conscienciosidade', key: -1 }, // Reverso validado
  { id: 20, text: "Indisciplinado(a)", trait: 'conscienciosidade', key: -1 }, // Reverso validado
  ...
  { id: 27, text: "Tímido(a)", trait: 'extroversao', key: -1 }, // Reverso validado
  { id: 28, text: "Silencioso(a)", trait: 'extroversao', key: -1 }, // Reverso validado
  { id: 29, text: "Reservado(a)", trait: 'extroversao', key: -1 }, // Reverso validado
  { id: 30, text: "Inibido(a)", trait: 'extroversao', key: -1 }, // Reverso validado
  ...
  { id: 37, text: "Frio(a)", trait: 'amabilidade', key: -1 }, // Reverso validado
  { id: 38, text: "Rude", trait: 'amabilidade', key: -1 }, // Reverso validado
  { id: 39, text: "Egoísta", trait: 'amabilidade', key: -1 }, // Reverso validado
  { id: 40, text: "Exigente", trait: 'amabilidade', key: -1 }, // Reverso validado
  ...
  { id: 46, text: "Ansioso(a)", trait: 'estabilidade', key: -1 }, // Reverso validado
  { id: 47, text: "Nervoso(a)", trait: 'estabilidade', key: -1 }, // Reverso validado
  { id: 48, text: "Temperamental", trait: 'estabilidade', key: -1 }, // Reverso validado
  { id: 49, text: "Inseguro(a)", trait: 'estabilidade', key: -1 }, // Reverso validado
  { id: 50, text: "Emotivo(a)", trait: 'estabilidade', key: -1 } // Reverso validado
];
                      ...
                      <div key={trait} className="relative print:mb-4 break-inside-avoid">
                        ...
                        <div className="h-4 bg-slate-100 rounded-full overflow-hidden relative print:border print:border-gray-400">
                          ...
                          <div 
                            ...
                            style={{ 
                              left: `${Math.max(0, userProfile[trait] - sem)}%`, 
                              width: `${sem * 2}%` 
                            }}
                          >
                            <div className="w-full h-full bg-slate-800/10 border-l border-r border-slate-500/50 box-border" title={`Intervalo de Confiança: ${userProfile[trait] - sem}% a ${userProfile[trait] + sem}%`}></div>
